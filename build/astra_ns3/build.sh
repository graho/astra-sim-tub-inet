...
WORKLOAD="${SCRIPT_DIR:?}"/../../examples/text_converter/text_workloads/AllGather10000B_${nodeNum}/AllGather10000B_${nodeNum}
...
LOGICAL_TOPOLOGY="${SCRIPT_DIR:?}"/../../examples/ns3/sample_${nodeNum}nodes_1D.json
